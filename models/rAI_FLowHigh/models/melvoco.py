...
from models.rAI_FLowHigh.models.bigvgan.init_vocoder import init_bigvgan
from models.rAI_FLowHigh.models.modules import spectral_normalize_torch
...
class MelVoco(nn.Module):
    def __init__(
        ...
        *,
        ...
        f_min=20,
        n_fft=int(2048/4),
        win_length=int(2048/4),
        hop_length=int(480/2),
        vocoder="bigvgan",
