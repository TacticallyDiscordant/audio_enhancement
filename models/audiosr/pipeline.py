...
import models.audiosr.latent_diffusion.modules.phoneme_encoder.text as text
from models.audiosr.latent_diffusion.models.ddpm import LatentDiffusion
from models.audiosr.latent_diffusion.util import get_vits_phoneme_ids_no_padding
from models.audiosr.utils import (
...
def make_batch_for_super_resolution(input_file=None, waveform=None, fbank=None):
    if waveform is None and input_file is not None:
        # Original logic if no waveform is provided
        log_mel_spec, stft, waveform, duration, target_frame = read_audio_file(input_file)
    elif waveform is not None and input_file is None: 
        ...
        raise Exception("Either load file or provide waveform!")
...
def super_resolution_from_wave(
    latent_diffusion,
    waveform,
    ddim_steps=200,
    guidance_scale=3.5,
    ...
    batch, duration = make_batch_for_super_resolution(waveform=waveform)
