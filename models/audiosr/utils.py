...
from models.audiosr.lowpass import lowpass
...
def download_checkpoint(checkpoint_name="basic"):
    cache_dir = "models/weights_and_configs/huggingface_cache"
...
def get_basic_config():
    return {
        ...
        "model": {
            "target": "models.audiosr.latent_diffusion.models.ddpm.LatentDiffusion",
            "params": {
                "first_stage_config": {
                    "base_learning_rate": 0.000008,
                    "target": "models.audiosr.latent_encoder.autoencoder.AutoencoderKL",
                    "params": {
                ...
                "scale_by_std": True,
                "unet_config": {
                    "target": "models.audiosr.latent_diffusion.modules.diffusionmodules.openaimodel.UNetModel",
                    "params": {
                        "image_size": 64,
                        "in_channels": 32,
                        "out_channels": 16,
                ...
                "cond_stage_config": {
                    "concat_lowpass_cond": {
                        ...
                        "target": "models.audiosr.latent_diffusion.modules.encoders.modules.VAEFeatureExtract",
                        "params": {
                            "first_stage_config": {
                                "base_learning_rate": 0.000008,
                                "target": "models.audiosr.latent_encoder.autoencoder.AutoencoderKL",
